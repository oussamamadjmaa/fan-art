<x-modal.form :title="isset($exhibition) ? __('Edit Exhibition') : __('Add Exhibition')">
    ...
    <div class="row">
        <div class="col-md-6"><x-form.input type="date" name="from_date" label="From date" :value="($exhibition?->from_date?->format('Y-m-d') ?? '')" /></div>
        <div class="col-md-6"><x-form.input type="date" name="to_date" label="To date" :value="($exhibition?->to_date?->format('Y-m-d') ?? '')" /></div>
    </div>
    <div class="row">
        <div class="col-md-6">
