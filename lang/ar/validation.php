...
return [
    ...
    'attributes' => [
        ...
        'officer_id'            => 'مسؤول الفرصة',
        'from_date'             => 'من تاريخ',
        'to_date'               => 'إلى تاريخ',
        'is_collective'         => 'جماعي أو فردي',
        'certificate_image'     => 'صورة الشهادة',
        "seo.title"             => "عنوان SEO",
        "seo.description"       => "وصف SEO",
        "seo.image"             => "صورة  SEO",
        "action_data.text"      => "نص الزر",
        "action_data.url"       => "رابط الزر",
        "action_data.color"     => "لون الزر",
        "action_data.countdown_date" => "تاريخ العد التنازلي",
